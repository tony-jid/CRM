...
namespace CRM.Data.Migrations
{
    ...
    [Migration("20180917022726_Update-status-actions")]
    partial class Updatestatusactions
    {
            ...
            modelBuilder.Entity("CRM.Models.Action", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "ALA1", ActionName = "Comment", ActionTarget = "Message", ControllerName = "LeadAssigments", DisplayName = "Comment lead", Icon = "batch-icon batch-speech-bubble-left-tip-solid-text", NextStateId = "S0", RequestType = "Post" },
                        ...
                        new { Id = "ALA3", ActionName = "Reject", ActionTarget = "Ajax", ControllerName = "LeadAssigments", DisplayName = "Reject lead", Icon = "fa fa-dollar", NextStateId = "SLA3", RequestType = "Put" },
                        ...
                        new { Id = "ALA5", ActionName = "ResendInvoice", ActionTarget = "Ajax", ControllerName = "LeadAssigments", DisplayName = "Re-send invoice", Icon = "batch-icon batch-icon-cross", NextStateId = "SLA5", RequestType = "Post" }
                    );
                });
