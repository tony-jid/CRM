...
namespace CRM.Data.Migrations
{
    ...
    [Migration("20180917023308_Update-status-actions-1")]
    partial class Updatestatusactions1
    {
            ...
            modelBuilder.Entity("CRM.Models.Action", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "ALA1", ActionName = "Comment", ActionTarget = "Message", ControllerName = "LeadAssigments", DisplayName = "Comment lead", Icon = "batch-icon batch-icon-speech-bubble-left-tip-solid-text", NextStateId = "S0", RequestType = "Post" },
                        new { Id = "ALA2", ActionName = "Accept", ActionTarget = "Ajax", ControllerName = "LeadAssigments", DisplayName = "Accept lead", Icon = "batch-icon batch-icon-tick", NextStateId = "SLA2", RequestType = "Put" },
                        new { Id = "ALA3", ActionName = "Reject", ActionTarget = "Ajax", ControllerName = "LeadAssigments", DisplayName = "Reject lead", Icon = "batch-icon batch-icon-cross", NextStateId = "SLA3", RequestType = "Put" },
                        new { Id = "ALA4", ActionName = "SendInvoice", ActionTarget = "Ajax", ControllerName = "LeadAssigments", DisplayName = "Send invoice", Icon = "fa fa-dollar", NextStateId = "SLA4", RequestType = "Post" },
                        new { Id = "ALA5", ActionName = "ResendInvoice", ActionTarget = "Ajax", ControllerName = "LeadAssigments", DisplayName = "Re-send invoice", Icon = "fa fa-dollar", NextStateId = "SLA5", RequestType = "Post" }
                    );
                });
