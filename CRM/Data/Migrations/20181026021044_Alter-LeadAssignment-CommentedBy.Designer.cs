...
namespace CRM.Data.Migrations
{
    ...
    [Migration("20181026021044_Alter-LeadAssignment-CommentedBy")]
    partial class AlterLeadAssignmentCommentedBy
    {
            ...
            modelBuilder.Entity("CRM.Models.Action", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "ALA1", ActionName = "CommentLead", ActionTarget = "Rating", ControllerName = "LeadAssignments", DisplayName = "Comment lead", Icon = "batch-icon batch-icon-speech-bubble-left-tip-text", NextStateId = "S0", RequestType = "Post" },
                        ...
                        new { Id = "ALA5", ActionName = "SendInvoice", ActionTarget = "Ajax", ControllerName = "LeadAssignments", DisplayName = "Re-send invoice", Icon = "fa fa-dollar", NextStateId = "SLA5", RequestType = "Post" }
                    );
                });
            ...
            modelBuilder.Entity("CRM.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ABN = "65 626 309 073", Email = "leads@comparisonadvantage.com.au", GST = 10.0, Logo = "logo-dark.png", Name = "Comparison Advantage" }
                    );
                });
