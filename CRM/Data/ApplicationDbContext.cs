    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Models.Action>().HasData(
                    new Models.Action { Id = "AL0", ControllerName = "Message", ActionName = "SendLeadMessage", NextStateId = "S0", Icon = "batch-icon batch-icon-envelope", DisplayName = "Send message", ActionTarget = "Message", RequestType = "Post", IsGroupAction = true, GroupActionDisplayName = "Message customers" },
                    new Models.Action { Id = "AL1", ControllerName = "Message", ActionName = "SendLeadRequestInfo", NextStateId = "SL4", Icon = "batch-icon batch-icon-envelope", DisplayName = "Request Info", ActionTarget = "Message", RequestType = "Post", IsGroupAction = true, GroupActionDisplayName = "Request info" },
                    ...
                    new Models.Action { Id = "AL4", ControllerName = "Reports", ActionName = "InvoiceByLeads", NextStateId = "SLA4", Icon = "fa fa-dollar", DisplayName = "Get invoices", ActionTarget = "Window", RequestType = "Get", IsGroupAction = true, GroupActionDisplayName = "Get invoices" },
                    new Models.Action { Id = "ALA0", ControllerName = "Message", ActionName = "SendAssignmentMessage", NextStateId = "S0", Icon = "batch-icon batch-icon-envelope", DisplayName = "Send message", ActionTarget = "Message", RequestType = "Post", IsGroupAction = true, GroupActionDisplayName = "Message partners" },
                    new Models.Action { Id = "ALA1", ControllerName = "LeadAssignments", ActionName = "CommentLead", NextStateId = "S0", Icon = "batch-icon batch-icon-speech-bubble-left-tip-text", DisplayName = "Comment lead", ActionTarget = "Rating", RequestType = "Post" },
                    ...
                    new Models.Action { Id = "ALA4", ControllerName = "Reports", ActionName = "InvoiceByAssignments", NextStateId = "SLA4", Icon = "fa fa-dollar", DisplayName = "Get invoice", ActionTarget = "Window", RequestType = "Get" },
                    new Models.Action { Id = "ALA5", ControllerName = "Reports", ActionName = "InvoiceByAssignments", NextStateId = "SLA5", Icon = "fa fa-dollar", DisplayName = "Get invoice", ActionTarget = "Window", RequestType = "Get" }
                );
            // State-Action data
