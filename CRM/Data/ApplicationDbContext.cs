    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Models.Action>().HasData(
                    ...
                    new Models.Action { Id = "AL4", ControllerName = "Leads", ActionName = "GetInvoices", NextStateId = "SLA4", Icon = "fa fa-dollar", DisplayName = "Get invoices", ActionTarget = "Ajax", RequestType = "Post", IsGroupAction = true, GroupActionDisplayName = "Get invoices" },
